...
pp.add_argument('--load-path', type=str, default='F:/mnt/SSD/det/VG/', help='Path to a directory containing a copy of the VG256 dataset.')
pp.add_argument('--save-path', type=str, default='F:/mnt/SSD/det/VG/', help='Path to output directory.')
args = pp.parse_args()
