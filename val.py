...
from pipeline.resnet_our import ResNet_cam
from pipeline.resnet_bce import ResNet_bce
def Args():
    ...
    parser.add_argument("--load_from", default="models_local/epoch_30.pth", type=str)
    # dataset
...
def main():
    ...
    if args.model == "resnet101": 
        #model = ResNet_bce(num_classes=args.num_cls, cutmix=args.cutmix)
